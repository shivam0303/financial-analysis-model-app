...
def total_revenue(data: dict, financial_index):
    ...
    for index, financial in enumerate(data.get("financials")):
        ...
        if index == financial_index:
            # print(financial.get("pnl").get("lineItems").get("net_revenue"))
            return financial.get("pnl").get("lineItems").get("net_revenue")
...
def total_borrowing(data: dict, financial_index):
    ...
    for index, financial in enumerate(data.get("financials")):
        if index == financial_index:
            return (
                financial.get("bs").get("liabilities").get("short_term_borrowings")
                + financial.get("bs").get("liabilities").get("long_term_borrowings")
            ) / total_revenue(data, financial_index)
...
def iscr(data: dict, financial_index):
    ...
    for index, financial in enumerate(data.get("financials")):
        if index == financial_index:
            return (
                financial.get("pnl").get("lineItems").get("profit_before_interest_and_tax")
                + financial.get("pnl").get("lineItems").get("depreciation")
                + 1
            ) / (
                financial.get("pnl").get("lineItems").get("interest") + 1
            )
